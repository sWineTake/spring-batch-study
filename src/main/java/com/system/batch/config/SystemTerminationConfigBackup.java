...
@Import(BatchConfig.class) // - 원시적 침투 버전
public class SystemTerminationConfigBackup {

    private final JobRepository jobRepository;
    private final PlatformTransactionManager transactionManager;
    // 의존성 주입으로 할당
    public SystemTerminationConfigBackup(JobRepository jobRepository, PlatformTransactionManager transactionManager) {
        // jobRepository는 BatchConfig가 상속한 DefaultBatchConfiguration에서 자동 생성
        this.jobRepository = jobRepository;
        // transactionManager는 BatchConfig에서 transactionManager() 선언 한 것
